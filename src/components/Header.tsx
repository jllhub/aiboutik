...
const Header = () => {
  ...
  return (
    <>
      {/* Navbar */}
      <div className="w-full bg-gradient-to-r from-yellow-400 via-purple-600 to-blue-600 py-1 px-4 flex items-center justify-center">
        <span className="text-white font-semibold tracking-wide text-center text-sm">
      ...
      <header className="flex justify-between items-center py-6 px-10 bg-white">
        ...
        >
          <a href="#" className="flex items-center h-full">{t('home')}</a>
          <a href="#" className="flex items-center h-full">Shein</a>
          <a href="#" className="flex items-center h-full">Temu</a>
          <a href="#" className="flex items-center h-full">Amazon</a>
          <a href="#" className="flex items-center h-full">{t('contact')}</a>
          <button
            className="bg-blue-600 text-white px-5 py-2 rounded-lg shadow hover:bg-blue-700 transition-colors duration-200 font-semibold flex items-center h-full"
            type="button"
          style={{color:"#fff",backgroundColor:"#5E18EC"}}>
            <svg
